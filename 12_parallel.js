...
const parallel = () => {
    Promise.resolve="https://jsonplaceholder.typicode.com/todos/1";
    Promise.resolve="https://jsonplaceholder.typicode.com/todos/2";
    Promise.resolve="https://jsonplaceholder.typicode.com/todos/3";
}
